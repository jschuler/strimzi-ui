...
export const returnExpress: (
  ...
  const sessionOpts: SessionOptions = {
    secret: 'CHANGEME', //TODO replace with value from config https://github.com/strimzi/kafka-management-ui/issues/111
    name: session.name,
    cookie: {
      maxAge: 1000 * 3600 * 24 * 30, //30 days as a starting point //TODO replace with value from config https://github.com/strimzi/kafka-management-ui/issues/111
    },
  };
